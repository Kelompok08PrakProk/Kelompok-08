...
button_back.place(relx=0.08, rely=0.2, anchor="w")

frame_tanggal_pinjam = ctk.CTkFrame(window_beranda, width=500, height=60, corner_radius=10, fg_color="#e3dfe6")
frame_tanggal_pinjam.place(relx=0.3, rely=0.4, anchor="center")
...
button_tanggal_pinjam.place(relx=0.23, rely=0.4, anchor="center")
...
button_tampilkan_pinjam.place(relx=0.4, rely=0.4, anchor="center")
...
frame_tanggal_kembali.place(relx=0.3, rely=0.55, anchor="center")
...
button_tanggal_kembali.place(relx=0.23, rely=0.55, anchor="center")
...
button_tampilkan_kembali.place(relx=0.4, rely=0.55, anchor="center")
